...
- (CLRegion*)dictToRegion:(NSDictionary*)dictionary
{
    ...
    isInOut = [[dictionary valueForKey:@"inout"] intValue];
      ...
      didDetermineState:(CLRegionState)state forRegion:(CLRegion *)region
{
    if(state == CLRegionStateInside)
    {
        ...
        if(isInOut==0){
            ...
            localNotif.alertBody = @"Entered Region";
    ...
    else if(state == CLRegionStateOutside)
    {
        ...
        if(isInOut==1){
            UILocalNotification *localNotif = [[UILocalNotification alloc] init];
            localNotif.fireDate = [NSDate dateWithTimeIntervalSinceNow:1];
            localNotif.alertBody = @"Exited Region";
            localNotif.timeZone = [NSTimeZone defaultTimeZone];
            [[UIApplication sharedApplication] scheduleLocalNotification:localNotif];
        }
        ...
        /*UIAlertView *alert = [[UIAlertView alloc] initWithTitle: @"Unknown Region"
